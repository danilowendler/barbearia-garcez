...
export function About() {
  return (
    <section id="sobre" className="scroll-mt-16 bg-surface-dark text-on-dark px-[5%] py-16 md:py-24 lg:py-28">
      <div className="mx-auto flex max-w-[1440px] flex-col items-center text-center">
        <Reveal className="mb-12 md:mb-16 lg:mb-20">
          <div className="mx-auto w-full max-w-lg">
            <p className="mb-3 text-[13px] font-bold tracking-[1.5px] uppercase text-on-dark-soft md:mb-4">
              Sobre
            </p>
            <h2 className="mb-5 text-3xl font-bold uppercase md:mb-6 md:text-5xl">
              Mais que uma barbearia, um refúgio no bairro.
            </h2>
